...
function OrderScreen({ params }) {
  ...
  async function deliverOrderHandler() {
    try {
      ...
      enqueueSnackbar('Order delivered!', { variant: 'success' })
    } catch (err) {
          ...
          <Grid item md={9} xs={12}>
            <Card className={classes.section}>
              <List>
                ...
                <ListItem>
                  {isDelivered ? `Delivered at ${deliveredAt}` : 'Not yet delivered'}
                </ListItem>
              </List>
            </Card>
            <Card className={classes.section}>
              <List>
                ...
                <ListItem>
                  {isPaid ? `Paid on ${paidAt}` : 'Not yet paid'}
                </ListItem>
              </List>
            </Card>
            <Card className={classes.section}>
...
export default dynamic(() => Promise.resolve(OrderScreen), { ssr: true })