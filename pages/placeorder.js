...
function PlaceOrderScreen() {
  ...
  const round2 = num => Math.round(num * 100 + Number.EPSILON) / 100 // ex: 123.456 => 123.46
        ...
        <Grid container spacing={1}>
          <Grid item md={9} xs={12}>
            ...
            <Card className={classes.section}>
              <List>
                <ListItem>
                  <Typography component='h2' variant='h2'>Order Item(s)</Typography>
                </ListItem>
                <ListItem>
                  <TableContainer>
                    <Table>
          ...
          <Grid item md={3} xs={12}>
            <Card className={classes.section}>
              <List>
                ...
                <ListItem>
                  <Button onClick={placeOrderHandler} variant='contained' color='primary' fullWidth>Place Order</Button>
                </ListItem>
                { loading && (
                  <ListItem>
                    <CircularProgress />
...
export default dynamic(() => Promise.resolve(PlaceOrderScreen), { ssr: true })